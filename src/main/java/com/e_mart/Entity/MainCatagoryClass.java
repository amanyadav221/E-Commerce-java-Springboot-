...
public class MainCatagoryClass {
	@Id
	private String name;
	...
	public MainCatagoryClass(String name, String fileName, String fileType, byte[] fileData, String status) {
		super();
		this.name = name;
		this.fileName = fileName;
		this.fileType = fileType;
